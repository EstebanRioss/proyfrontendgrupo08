...
export class AuthService {
    ...
    updateUsuario(userId: string, userData: Partial<Usuario>): Observable<any> {
    ...
    cambiarContrasena(userId: string, passwordData: { contrasenaActual: string, nuevaContrasena: string }): Observable<any> {
        return this.http.put<any>(`${this.apiUrl}/${userId}/cambiar-contrasena`, passwordData).pipe(
            catchError((error: HttpErrorResponse) => {
